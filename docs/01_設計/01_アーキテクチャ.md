...
3. 個別APIは個別基盤や共通基盤サービスを経由し、必要に応じてデータベースや外部サービスと連携
4. 共通APIや個別基盤も必要に応じてデータベースや外部サービスと連携
5. 結果を画面に返却
...
sequenceDiagram
  ...
  IndividualAPI-->>IndividualUI: レスポンス
